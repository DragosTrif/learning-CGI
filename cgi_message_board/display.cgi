...
sub print_page_end {
	...
	print "<a href=\"post.cgi\">create new topic</a> |\n";
	print "<a href=\"delete_topic.cgi\">delete topic</a> </p>\n";
	print "</body>\n</html>\n";
}
...
sub print_topic_index {
	eval {
			...
			#my @topics = <$topic_directory/*.xml>;
			my @topics = grep {/\.xml/} readdir($dh);
			print "<p>\n";
			foreach my $topic (@topics) {
				$topic =~ s/(.+)\.xml/$1/i;
				parse_topic(open_topic($topic));
				print "<b><a href=\"display.cgi?topic=$topic\">";
